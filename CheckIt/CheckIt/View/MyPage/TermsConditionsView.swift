...
제 1장 총칙
제 1조 (목적)
이 약관은 “CheckIt”(이하 “회사”라 합니다)이 제공하는 “동아리 출석 관리 서비스”(이하 ‘서비스’라 합니다)를 회사와 이용계약을 체결한 ‘고객’이 이용함에 있어 필요한 회사와 고객의 권리 및 의무, 기타 제반 사항을 정함을 목적으로 합니다.
...
제 2장 서비스의 이용
제 3조 (가입자격)
① 서비스에 가입할 수 있는 자는 Application을 설치가능한 모든 사람 입니다.
